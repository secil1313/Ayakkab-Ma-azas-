public class Stiletto extends Topuklu{
    private String stilettoCesidi;

    public String getStilettoCesidi() {
        return stilettoCesidi;
    }

    public void setStilettoCesidi(String stilettoCesidi) {
        this.stilettoCesidi = stilettoCesidi;
    }

    public Stiletto(String stilettoCesidi) {
        this.stilettoCesidi = stilettoCesidi;
    }
    ...
    public String toString() {
        return
                "Stiletto çesidi " + stilettoCesidi+"dur.";
    }

    @Override
    public void topukBoyuKac(int topukBoyu) {
        System.out.println("Ayakkabının topuk boyu "+topukBoyu+"dur.");
