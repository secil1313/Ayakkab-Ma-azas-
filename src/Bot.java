public class Bot extends Mevsimlik{
   private String botCesidi;

    public Bot() {
    }

    public Bot(String botCesidi) {
        this.botCesidi = botCesidi;
    }

    public String getBotCesidi() {
        return botCesidi;
    }

    public void setBotCesidi(String botCesidi) {
        this.botCesidi = botCesidi;
    }
    ...
    public void isikliMi(boolean i) {
        if(i==true) {
            System.out.println("Bu ayakkabı ışıklı bir bottur.");
        }else{
            System.out.println("Bu ayakkabı ışıksız bir bottur");
        }
    }
